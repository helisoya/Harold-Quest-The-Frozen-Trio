...
public class AudioManager : MonoBehaviour
{
    ...
    public void PlaySong(AudioClip song, float maxVolume = 1f, float pitch = 1f, float startingVolume = 0f, bool playOnStart = true, bool loop = true)
    {
        if (song != null)
        {
            ...
            {
                activeSong = new SONG(song, maxVolume, pitch, startingVolume, playOnStart, loop, bgmGroup);
            }
        }
        else
        {
    ...
    public class SONG
    {
        ...
        public SONG(AudioClip clip, float _maxVolume, float pitch, float startingVolume, bool playOnStart, bool loop, AudioMixerGroup bgmGroup)
        {
